...
RSpec.describe CheckinsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new checkin" do

        post :create, params: {checkin: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(checkin_url(Checkin.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new checkin" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the checkin" do
        checkin = Checkin.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the checkin" do
        checkin = Checkin.create! valid_attributes
